...
jQuery(function ($) {
  ...
  function generateCarousel() {
    $(".carousel").each(function () {
      ...
      var addIndicators = !$(this).find(".carousel-indicators").length && $(this).attr("data-custom-indicators") != "false";
      ...
      try {
        if ($items.length <= 1) {
          var $prev;
          if (($prev = $(this).find('.carousel-control-prev').get(0)).length) $prev.hide();
          var $next;
          if (($next = $(this).find('.carousel-control-next').get(0)).length) $next.hide();
        }
      } catch (e) {
        console.error(e);
      }
  ...
  function multiItemCarousel() {
    var items = document.querySelectorAll('.multi-carousel .carousel-item');
    items.forEach(function (el) {
      var minPerSlide = $(el).attr("data-custom-slides") || 3;
...
/***/ "./assets/src/scss/bootstrap.scss":
/*!****************************************!*\
  !*** ./assets/src/scss/bootstrap.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdaraluz_theme"] = self["webpackChunkdaraluz_theme"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/bootstrap","css/main"], () => (__webpack_require__("./assets/src/js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["css/bootstrap","css/main"], () => (__webpack_require__("./assets/src/scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/bootstrap","css/main"], () => (__webpack_require__("./assets/src/scss/bootstrap.scss")))
